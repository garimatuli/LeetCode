...
// Runtime: 180 ms, faster than 23.16 % of JavaScript online submissions; Memory: 110.5 MB
/**
...
var buildTree = function (inorder, postorder) {
  ...
  let righPostorder = postorder.slice(pivot, -1);

  return {
    val: root,
    left: buildTree(leftInorder, leftPostorder),
    right: buildTree(rightInorder, righPostorder),
  };
};
